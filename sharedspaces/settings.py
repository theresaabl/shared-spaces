"""
Django settings for sharedspaces project.
...
ROOT_URLCONF = 'sharedspaces.urls'
...
WSGI_APPLICATION = 'sharedspaces.wsgi.application'
...
USE_L10N = False  # To apply INPUT_FORMATS
